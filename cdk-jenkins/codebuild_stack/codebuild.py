        ...
        **kwargs
        ...
        secondary_sources = [
            codebuild.Source.git_hub(
                owner="kaggggggga", repo="devsecops-jenkins-scanner", branch_or_ref=branch_or_ref, identifier="secondary_source_1"
            ),
        ]
        # code build project for execute codebuild_behave_image_build_buildspec.yaml
        ...
        codebuild_gaulant = codebuild.Project(
            ...
            source=codebuild.Source.git_hub(
                owner="kaggggggga", repo="devsecops-jenkins-scanner"
            ),
            environment=codebuild.BuildEnvironment(
                build_image=codebuild.LinuxBuildImage.AMAZON_LINUX_2_5,
                compute_type=codebuild.ComputeType.MEDIUM,
